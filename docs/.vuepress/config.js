...
export default defineUserConfig({
                    ...
                    sidebar: [
                        {
                            text: 'Vue3基础',
                            icon: 'ic:baseline-dashboard',
                            items: ['Vue3-简介概述', 'Vue3-setup', 'Vue3-ref&reactive', 'Vue3-computed&watch', 'Vue3-ref&props', 'Vue3-生命周期','Vue3-实现函数式弹框', 'Vue3-自定义hook', 'Vue3-router', 'Vue3-Pinia', 'Vue3-组件通信', 'Vue3-Slot插槽', 'Vue3-其他API'
                            ]
                        },
                        {
                            text: 'Vue3进阶',
    ...
    title: '前端笔记',
    // 介绍
    description: '前端笔记，包括内容：日常记录|前端学习|前端笔记|问题记录，HTML，CSS，JavaScript，Vue，Node.js，NPM。',
    head: [
        ['link', {
            rel: 'icon',
            href: '/favicon.ico'
        ...
        ['meta', {
            name: 'keywords',
            href: '前端笔记,日常记录,前端学习,前端笔记,问题记录,HTML,CSS,JavaScript,Vue,Node.js'
        }],
        // 去掉字体
        // ['link', {
        //     rel: 'stylesheet',
